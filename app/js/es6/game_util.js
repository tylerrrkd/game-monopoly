  ...
  return {
    ...
    fromZoomMax(obj, cb, time) {
      game.add
        .tween(obj)
        .from(
          { width: obj.width * 4.2, height: obj.height * 4.2 },
          time,
          Phaser.Easing.Linear.In,
          true,
          0,
    ...
    fromZoomMax2(obj, cb) {
      game.add
        .tween(obj)
        .from(
          { width: obj.width * 10.2, height: obj.height * 10.2, alpha: 0.3 },
          250,
          Phaser.Easing.Linear.In,
          true,
          0,
    ...
    fromZoomMin(obj, cb, time) {
      game.add
        .tween(obj)
        .from(
          { width: obj.width * 0.02, height: obj.height * 0.02 },
          time,
          Phaser.Easing.Linear.In,
          true,
          0,
    ...
    toZoomMin(obj, time, cb) {
      game.add
        .tween(obj)
        .to(
          { width: obj.width * 0.1, height: obj.height * 0.1, alpha: 0 },
          durTime,
          Phaser.Easing.Linear.In,
          true,
          time,
    ...
    toZoomMax(obj, time, cb) {
      game.add
        .tween(obj)
        .to(
          { width: obj.width * 5.1, height: obj.height * 5.1, alpha: 0 },
          durTime,
          Phaser.Easing.Linear.In,
          true,
          time,
    ...
    zoomandmax(obj) {
      game.add
        .tween(obj)
        .to(
          { width: obj.width * 1.08, height: obj.height * 1.08 },
          400,
          Phaser.Easing.Linear.In,
          true,
          0,
