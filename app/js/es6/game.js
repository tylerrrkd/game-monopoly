    ...
    preload() {
      ...
      return {
        ...
        preload() {
          ...
          game.load.image(
            "redPackRight",
            baseImgUrl + "road/twly_redPackRight.png"
          );
          game.load.image(
            "redPackLeft",
            baseImgUrl + "road/twly_redPackLeft.png"
          );
          ...
          game.load.atlasXML(
            "dice",
            baseImgUrl + "twly_dice.png",
            baseImgUrl + "twly_dice.xml"
          );
          game.load.image("diceBtn", baseImgUrl + "home/twly_diceBtn2.png"); // 骰子按钮
          // 角色
          game.load.atlasXML(
            "right-top",
            baseImgUrl + "role/right-top.png",
            baseImgUrl + "role/right-top.xml"
          );
          game.load.atlasXML(
            "left-top",
            baseImgUrl + "role/left-top.png",
            baseImgUrl + "role/left-top.xml"
          );
          game.load.atlasXML(
            "right-bottom",
            baseImgUrl + "role/right-bottom.png",
            baseImgUrl + "role/right-bottom.xml"
          );
          game.load.atlasXML(
            "left-bottom",
            baseImgUrl + "role/left-bottom.png",
            baseImgUrl + "role/left-bottom.xml"
          );
          // audio
      ...
      return {
        ...
        createDiceBtn() {
          ...
          diceTween = game.add
            .tween(diceBtn)
            .to(
              { width: diceBtn.width * 1.2, height: diceBtn.height * 1.2 },
              300,
          ...
          diceText = game.add.text(
            w * 0.88,
            h * 0.821,
            "次数: " + that.initUser.zscount,
            { fill: "#d30000", font: "bold 25px" }
          );
          diceText.anchor.set(0.5);
          diceTextTween = game.add
            .tween(diceText)
            .to(
              { width: diceText.width * 1.2, height: diceText.height * 1.2 },
              300,
              Phaser.Easing.Linear.In,
              true,
              0,
          ...
          diceBtn.events.onInputUp.add(() => {
            ...
            if (that.initUser.zscount <= 0) {
              that.tips.content =
                "你的投掷次数已用完，赠送点心给好友，好友领取后你可以获得投掷机会喔！";
            ...
            game.add
              .tween(diceBtn)
              .to(
                { width: diceBtn.width * 1.3, height: diceBtn.height * 1.3 },
                200,
                Phaser.Easing.Linear.In,
                true,
                0,
            ...
            game.add
              .tween(diceText)
              .to(
                { width: diceText.width * 1.3, height: diceText.height * 1.3 },
                200,
                Phaser.Easing.Linear.In,
                true,
                0,
            ...
            //     if (data.code == 200) {
            const resultGrid =
              Math.floor(6 * Math.random()) + 1 + role.currentId;
            const data = {
              resultGrid,
              isBox: true,
              receiveCount: 1,
